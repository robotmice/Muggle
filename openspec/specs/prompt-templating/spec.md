# Capability: Prompt Templating

## Purpose
Prompt Templating enables dynamic prompt generation by parsing metadata and rendering templates with variable substitution and logic.
