# Capability: graph-node-architecture

## Purpose

Defines the architecture and conventions for LangGraph node implementation in the muggle project, including the standard node contract, sub-package layout by pipeline stage, dependency injection patterns, and rules for structured output model locality.
